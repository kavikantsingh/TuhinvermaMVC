LAPP.controller('TranscriptController', function ($scope, $rootScope, mySharedService, SchoolInfoFactory, $window, $timeout) {
    $scope.hasShow = 'false';
    ...
    $scope.Save_final = function () {
        ...
        var isValid = false;
        var listresult = [];;
        $("#transcript .documentContainer").each(function () {
